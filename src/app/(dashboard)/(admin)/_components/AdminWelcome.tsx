...
export default function WelcomeAdminPage() {
  ...
  const addStaff = () => {
    ...
    if (staffInput.roles.includes("teacher") && !staffInput.subject) {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            ...
            {staffInput.roles.includes("teacher") && (
              <div>
                ...
                <Input
                  value={staffInput.subject || ""}
                  placeholder="e.g., Mathematics"
                  onChange={(e) =>
                    setStaffInput({ ...staffInput, subject: e.target.value })
                  }
                />
              </div>
            )}
            ...
            {staffInput.roles.includes("formTeacher") && (
              <div>
                <Label className="mb-2">Form Class</Label>
                <Select
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder={"Select form teacher class"} />
                  </SelectTrigger>
                  <SelectContent>
                    {classes.map((sch, i) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    ...
                    {staff.subject && ` | Subject: ${staff.subject}`}
